...
PYBIND11_MODULE(utils, module)
{
  ...
  module.def("interpolate_zeros_2", &matrix_ops::interpolate_zeros_2, "takes in a matrix and fills all the 0-valued elements with interpolations from nearby values");
}
